...
project).
Source: https://prino.neocities.org/zOS/ehipli.exec.html
Project: Robert AH Prins' "EHI"/ISPF-edit-macro suite for z/OS, part of his
         ...
         edit macro to convert PL/I source to syntax-highlighted HTML.
         Copyright (c) Robert AH Prins, 2007-2024. The source page renders
...
/*** trace ?r ***************************************************** \| *
*               (C) Copyright Robert AH Prins, 2007-2024               *
************************************************************************
*  ------------------------------------------------------------------  *
* | Date       | By   | Remarks                                      | *
* |------------+------+----------------------------------------------| *
* |            |      |                                              | *
* |------------+------+----------------------------------------------| *
* | 2024-02-25 | RAHP | - improve merging of consecutive keywords    | *
* |            |      | - additional V6R1 keywords                   | *
* |------------+------+----------------------------------------------| *
* | 2021-01-06 | RAHP | - process new end-of-line (.//.) comments    | *
* |            |      | - merge highlighting of consecutive keywords | *
* |            |      |   and separators                             | *
* |            |      | - additional V5Rx keywords                   | *
* |------------+------+----------------------------------------------| *
* | 2018-01-22 | RAHP | Add V5R2 keywords                            | *
* |------------+------+----------------------------------------------| *
...
build_html:
  ...
  do until rxdata == ''
    ...
    +-----------------------------------------------------------------*/
    if kwbegin            = 1 &,
       pos(c1, separator) = 0 then      /*  +/-*=<>&^|.,:;'()"x2c(00) */
      do                                /* ^                          */
    ...
    | of a new keyword                                                 |
    |                                                                  |
    | Actually it's not, as PL/I has no keywords, so a name like       |
    | "this.date.time" should not really highlight "date" or "time",   |
    | but we behave just as ISPF.                                      |
    +-----------------------------------------------------------------*/
    ...
    select
      ...
      when (c1          = '*'     |,
        ...
        do
          ...
          if pos("NOT('", ruxdata) \= 0 then
            do
              parse value ruxdata with . "NOT('" !not ")" .

              special_hilite = special_hilite || !not
              separator      = ?not || separator
            end

          if pos("OR('", ruxdata) \= 0 then
            do
              parse value ruxdata with . "OR('" !or ")" .

              special_hilite = special_hilite || !or
      ...
      when sh > 0    &,
        ...
        select
          ...
          when c2 = '^<' |,
               c2 = '^>' then
            do
              sc      = wordpos(right(c2), special_chars)
              tempout = tempout || col_spc || '^' ||,
                        word(special_html, sc)'</em>'
              rxdata  = substr(rxdata, 3)
            end
          ...
          /*-----------------------------------------------------------+
          | New end-of-line comment                                    |
          +-----------------------------------------------------------*/
          when c2 = '//' then
            do
              !c      = pos('0d0a'x, rxdata)
              tempout = tempout || col_com ||,
                        strip(substr(rxdata, 1, !c - 1)) ||,
                        '</em>' || '0d0a'x
              rxdata  = substr(rxdata, !c + 2)
            end
          ...
          when c3 = '**=' |,
               ...
               c3 = !or || !or || '=' then
            do
              tempout = tempout || col_spc || c3'</em>'
              rxdata  = substr(rxdata, 4)
            end
      ...
      when keyword.kw = 1 &,
        ...
        do
          ...
          if right(strip(tempout), length(prev_kw)) = prev_kw then
            do
              !       = lastpos('</em>', tempout)
              tempout = substr(tempout, 1, ! - 1) ||,
                        substr(tempout, ! + 5) || kw'</em>'
            end
          else
    ...
    if length(tempout) > 512 then
      do
        ! = lastpos('<em class="r">', tempout)

        if ! \= 0 then
          do
            htmlout = htmlout || substr(tempout, 1, ! - 1);
            tempout = substr(tempout, !)
          end
        else
          do
...
build_list_of_keywords:
  ...
  keyword.BIND                   = 1
  keyword.BINSEARCH              = 1                        /* EP 5.2 */
  keyword.BINSEARCHX             = 1                        /* EP 5.2 */
  keyword.BINVALUE               = 1
  keyword.BIT                    = 1
  keyword.BITLOC                 = 1
  ...
  keyword.CMPAT                  = 1
  keyword.COBOL                  = 1
  keyword.CODEPAGE               = 1                        /* EP 5.2 */
  keyword.COL                    = 1
  keyword.COLLAPSE               = 1                        /* EP 5.2 */
  keyword.COLLATE                = 1
  keyword.COLUMN                 = 1
  keyword.COMMENT                = 1
  keyword.COMPARE                = 1
  ...
  keyword.DAYSTOMICROSECS        = 1                        /* EP 5.2 */
  ...
  keyword.FLOOR                  = 1
  keyword.FLUSH                  = 1
  keyword.FOLDEDFULLMATCH        = 1                        /* EP 5.3 */
  keyword.FOLDEDSIMPLEMATCH      = 1                        /* EP 5.3 */
  keyword.FOFL                   = 1
  keyword.FORMAT                 = 1
  keyword.FORTRAN                = 1
  keyword.FREE                   = 1
  ...
  keyword.GET                    = 1
  keyword.GETENV                 = 1
  keyword.GETJCLSYMBOL           = 1                        /* EP 5.2 */
  keyword.GETSYSINT              = 1                        /* EP 5.3 */
  keyword.GETSYSWORD             = 1                        /* EP 5.2 */
  keyword.GO                     = 1
  keyword.GOTO                   = 1
  keyword.GRAPHIC                = 1
  keyword.GTCA                   = 1                        /* EP 6.1 */
  keyword.GX                     = 1
  keyword.HANDLE                 = 1
  keyword.HBOUND                 = 1
  keyword.HBOUNDACROSS           = 1                        /* EP 4.2 */
  keyword.HEX                    = 1
  keyword.HEX8                   = 1                        /* EP 5.2 */
  keyword.HEXADEC                = 1
  keyword.HEXDECODE              = 1                        /* EP 5.1 */
  keyword.HEXDECODE8             = 1                        /* EP 5.1 */
  keyword.HEXIMAGE               = 1
  keyword.HEXIMAGE8              = 1                        /* EP 5.2 */
  keyword.HIGH                   = 1
  keyword.HUGE                   = 1
  keyword.IAND                   = 1
  ...
  keyword.IEOR                   = 1
  keyword.IF                     = 1
  keyword.IFTHENELSE             = 1                        /* EP 5.3 */
  keyword.IGNORE                 = 1
  keyword.IMAG                   = 1
  keyword.IN                     = 1
  keyword.INARRAY                = 1                        /* EP 5.2 */
  keyword.INDEX                  = 1
  keyword.INDEXAREA              = 1
  keyword.INDEXED                = 1
  keyword.INDEXR                 = 1                        /* EP 4.4 */
  keyword.INDFOR                 = 1                        /* EP 4.4 */
  ...
  keyword.LOG2                   = 1
  keyword.LOW                    = 1
  keyword.LOWERASCII             = 1                        /* EP 5.3 */
  keyword.LOWERCASE              = 1
  keyword.LOWERLATIN1            = 1                        /* EP 5.3 */
  keyword.LOWER2                 = 1
  keyword.MACCOL                 = 1
  keyword.MACLMAR                = 1
  keyword.MACNAME                = 1
  ...
  keyword.MAX                    = 1
  keyword.MAXDATE                = 1                        /* EP 5.3 */
  keyword.MAXEXP                 = 1
  keyword.MAXLENGTH              = 1
  keyword.MAXVAL                 = 1                        /* EP 5.2 */
  keyword.MEMCONVERT             = 1                        /* EP 3.7 */
  keyword.MEMCOLLAPSE            = 1                        /* EP 5.2 */
  ...
  keyword.MEMREPLACE             = 1                        /* EP 5.3 */
  keyword.MEMSEARCH              = 1                        /* EP 3.3 */
  keyword.MEMSEARCHR             = 1                        /* EP 3.3 */
  keyword.MEMSQUEEZE             = 1                        /* EP 5.2 */
  keyword.MEMVERIFY              = 1                        /* EP 3.3 */
  keyword.MEMVERIFYR             = 1                        /* EP 3.3 */
  keyword.MICROSECS              = 1                        /* EP 5.2 */
  keyword.MICROSECSTODATE        = 1                        /* EP 5.2 */
  keyword.MICROSECSTODAYS        = 1                        /* EP 5.2 */
  keyword.MIN                    = 1
  keyword.MINEXP                 = 1
  keyword.MINVAL                 = 1                        /* EP 5.2 */
  keyword.MOD                    = 1
  keyword.MPSTR                  = 1
  keyword.MULTIPLY               = 1
  keyword.NAME                   = 1
  ...
  keyword.ONCONDID               = 1
  keyword.ONCOUNT                = 1
  keyword.ONEXPECTED             = 1                        /* EP 5.2 */
  keyword.ONFILE                 = 1
  keyword.ONGSOURCE              = 1
  keyword.ONHBOUND               = 1                        /* EP 6.1 */
  keyword.ONKEY                  = 1
  keyword.ONLINE                 = 1                        /* EP 3.8 */
  keyword.ONLOC                  = 1
  keyword.ONLBOUND               = 1                        /* EP 6.1 */
  keyword.ONOFFSET               = 1                        /* EP 3.7 */
  keyword.ONOPERATOR             = 1                        /* EP 5.3 */
  keyword.ONPACKAGE              = 1                        /* EP 5.2 */
  keyword.ONPROC                 = 1                        /* EP 5.2 */
  keyword.ONPROCEDURE            = 1                        /* EP 5.2 */
  keyword.ONSOURCE               = 1
  keyword.ONSUBCODE              = 1
  keyword.ONSUBCODE2             = 1                        /* EP 5.1 */
  keyword.ONSUBSCRIPT            = 1                        /* EP 6.1 */
  keyword.ONTEXT                 = 1                        /* EP 5.2 */
  keyword.ONUCHAR                = 1                        /* EP 5.3 */
  keyword.ONWCHAR                = 1
  keyword.ONUSOURCE              = 1                        /* EP 5.3 */
  keyword.ONWSOURCE              = 1
  keyword.OPEN                   = 1
  keyword.OPTIONAL               = 1
  keyword.OPTIONS                = 1
  ...
  keyword.PLISRTC                = 1
  keyword.PLISRTD                = 1
  keyword.PLISTCKLOCAL           = 1                        /* EP 5.3 */
  keyword.PLISTCKPLOCAL          = 1                        /* EP 6.1 */
  keyword.PLISTCKUTC             = 1                        /* EP 5.3 */
  keyword.PLISTK                 = 1                        /* EP 4.5 */
  keyword.PLISTCKP               = 1                        /* EP 6.1 */
  keyword.PLISTKE                = 1                        /* EP 4.5 */
  keyword.PLISTCKELOCAL          = 1                        /* EP 5.3 */
  keyword.PLISTCKEUTC            = 1                        /* EP 5.3 */
  keyword.PLISTCKPUTC            = 1                        /* EP 6.1 */
  ...
  keyword.PUT                    = 1
  keyword.PUTENV                 = 1
  keyword.QUALIFY                = 1                        /* EP 5.3 */
  keyword.QUICKSORT              = 1                        /* EP 5.3 */
  keyword.QUICKSORTX             = 1                        /* EP 5.3 */
  keyword.QUOTE                  = 1
  keyword.RADIX                  = 1
  keyword.RAISE2                 = 1
  keyword.RANDOM                 = 1
  ...
  keyword.ROUNDTOEVEN            = 1                        /* EP 5.2 */
  keyword.SAMEKEY                = 1
  keyword.SCALARVARYING          = 1
  keyword.SCALE                  = 1
  keyword.SCALEVAL               = 1                        /* EP 5.3 */
  keyword.SCRUBOUT               = 1                        /* EP 5.3 */
  keyword.SEARCH                 = 1
  keyword.SEARCHR                = 1
  keyword.SECS                   = 1
  ...
  keyword.STATIC                 = 1
  keyword.STATUS                 = 1
  keyword.STCKETODATE            = 1                        /* EP 5.2 */
  keyword.STCKTODATE             = 1                        /* EP 5.3 */
  keyword.STG                    = 1
  keyword.STMT                   = 1
  keyword.STOP                   = 1
  keyword.STORAGE                = 1
  ...
  keyword.UNDERFLOW              = 1
  keyword.UNDF                   = 1
  keyword.UNHEX                  = 1                        /* EP 5.3 */
  keyword.UNLOCK                 = 1
  keyword.UNSIGNED               = 1
  keyword.UNSPEC                 = 1
  keyword.UNTIL                  = 1
  keyword.UPDATE                 = 1
  keyword.UPPERCASEASCII         = 1                        /* EP 5.3 */
  keyword.UPPERLATIN1            = 1                        /* EP 5.3 */
  ...
  keyword.UUID4                  = 1                        /* EP 5.3 */
  keyword.UVALID                 = 1                        /* EP 3.8 */
  keyword.UWIDTH                 = 1                        /* EP 3.8 */
  keyword.VALID                  = 1
  keyword.VALIDDATE              = 1
  keyword.VALIDVALUE             = 1                        /* EP 5.3 */
  keyword.VALUE                  = 1
  keyword.VALUELIST              = 1                        /* EP 5.3 */
  keyword.VALUELISTFROM          = 1                        /* EP 5.3 */
  keyword.VAR                    = 1
  keyword.VARGLIST               = 1
  keyword.VARGSIZE               = 1
  keyword.VARIABLE               = 1
  ...
  keyword.WEEKDAY                = 1
  keyword.WHEN                   = 1
  keyword.WHEREDIFF              = 1                        /* EP 6.1 */
  keyword.WHIGH                  = 1
  keyword.WHILE                  = 1
  keyword.WHITESPACECOLLAPSE     = 1 /* Deprecated 5.2 */   /* EP 4.4 */
  keyword.WHITESPACEREPLACE      = 1 /* Deprecated 5.2 */   /* EP 4.4 */
  keyword.WIDECHAR               = 1
  keyword.WIDEPIC                = 1                        /* EP 4.4 */
  keyword.WLOW                   = 1
  keyword.WRITE                  = 1
  keyword.WSCOLLAPSE             = 1                        /* EP 5.2 */
  keyword.WSCOLLAPSE16           = 1                        /* EP 5.2 */
  keyword.WSREPLACE              = 1                        /* EP 5.2 */
  keyword.WSREPLACE16            = 1                        /* EP 5.2 */
  keyword.XDCL                   = 1                        /* EP 6.1 */
  keyword.XDECLARE               = 1                        /* EP 6.1 */
  keyword.XMLCHAR                = 1                        /* EP 3.3 */
  keyword.XMLCLEAN               = 1 /* Deprecated 5.2 */   /* EP 4.4 */
  keyword.XMLCONTENT             = 1                        /* EP 5.1 */
  keyword.XMLNAME                = 1                        /* EP 5.3 */
  keyword.XMLSCRUB               = 1                        /* EP 5.2 */
  keyword.XMLSCRUB16             = 1                        /* EP 5.2 */
  keyword.XMLUCHAR               = 1                        /* EP 5.3 */
