...
project).
Source: https://prino.neocities.org/zOS/ehihelp.exec.html
Project: Robert AH Prins' "EHI"/ISPF-edit-macro suite for z/OS, part of his
         zOS-Tools page (https://prino.neocities.org/zOS/zOS-Tools) -- help-
         screen display exec for the whole EHIxxxx macro family. Copyright
         (c) Robert AH Prins, 2007-2016. The source page renders it as
         syntax-highlighted HTML (via the author's own EHIREXX.rex
