...
project).
Source: https://prino.neocities.org/zOS/ehisupc.exec.html
Project: Robert AH Prins' "EHI"/ISPF-edit-macro suite for z/OS, part of his
         ...
         edit macro to convert SuperC compare-output to syntax-highlighted
         HTML. Copyright (c) Robert AH Prins, 2007-2016. The source page
