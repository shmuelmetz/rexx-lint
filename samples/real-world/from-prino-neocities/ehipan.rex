...
project).
Source: https://prino.neocities.org/zOS/ehipan.exec.html
Project: Robert AH Prins' "EHI"/ISPF-edit-macro suite for z/OS, part of his
         ...
         edit macro to convert ISPF panel source to syntax-highlighted HTML.
         Copyright (c) Robert AH Prins, 2007-2016. The source page renders
