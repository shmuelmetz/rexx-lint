...
project).
Source: https://prino.neocities.org/zOS/ehirexx.exec.html
Project: Robert AH Prins' "EHI"/ISPF-edit-macro suite for z/OS, part of his
         ...
         edit macro to convert Rexx source to syntax-highlighted HTML.
         Copyright (c) Robert AH Prins, 2007-2016; Copyright (c) Stefan B,
         2007-2007. The source page renders it as syntax-highlighted HTML
         (via the author's own EHIREXX.rex converter, one of this same
