...
project).
Source: https://prino.neocities.org/zOS/ehijcl.exec.html
Project: Robert AH Prins' "EHI"/ISPF-edit-macro suite for z/OS, part of his
         ...
         edit macro to convert JCL to syntax-highlighted HTML. Copyright (c)
         Robert AH Prins, 2007-2016. The source page renders it as syntax-
         highlighted HTML (via the author's own EHIREXX.rex converter, one
         of this same suite) rather than serving plain text -- the HTML
         wrapper and <em class="..."> highlighting spans were stripped
         mechanically to recover this plain source, with the recovered text
         verified to contain no leftover markup or HTML entities before
         being saved here.
